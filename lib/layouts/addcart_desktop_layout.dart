...
class AddCartDesktopLayout extends StatefulWidget {
  const AddCartDesktopLayout({super.key});

  @override
  State<AddCartDesktopLayout> createState() => _AddCartDesktopLayoutState();
}

class _AddCartDesktopLayoutState extends State<AddCartDesktopLayout> {
  var uuid = Uuid();

...
import 'package:bizbora/widgets/next_page_button.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:bizbora/screens/homepage_screen.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              if (MediaQuery.of(context).size.width > 1285)
                Padding(
                  padding: const EdgeInsets.only(left: 535, bottom: 50),
                  child: Row(
                    children: [
                      NextPageButton(
                        button: () {},
                        ...
                        style: w600Size16Colorblackgrey,
                      ),
                      NextPageButton(
                        button: () {},
                        page: '1',
                        color: kblack,
                        style: w600Size16Colorwhite,
                      ),
                      NextPageButton(
                        button: () {},
                        page: '2',
